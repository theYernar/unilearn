      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () async {
            ...
            // Если результат 'Отмена', ничего не делаем
          },
          icon: const Icon(
...
class _QuizWidgetState extends State<QuizWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final int totalQuestion = widget.questions.length;
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: Text(
                '$totalQuestion / ${_currentQuestionIndex + 1}',
                style: GoogleFonts.nunito(
                  fontSize: 24,
                  fontWeight: FontWeight.w500,
                ),
                  ...
                  onPressed: () {
                    ...
                    setState(() {
                      if (_currentQuestionIndex < widget.questions.length - 1) {
                        ...
                        // Конец теста
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Тест завершён!')),
                        );
                      }
                    });
                  },
